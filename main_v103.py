...
# 从根目录下文件中调用的类
from Init_Window import Ui_MainWindow ### PyQt 界面样式
from OCR_iFLY_v103 import get_result ### 讯飞接口
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.conf.read(os.path.join(BASE_DIR, 'config.ini'), encoding="utf-8")  # 从全局路径读取配置文件
